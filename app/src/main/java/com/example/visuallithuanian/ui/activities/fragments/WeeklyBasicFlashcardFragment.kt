...
class WeeklyBasicFlashcardFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.imageFlashCard.setOnClickListener {
            ...
            currentTripleIndex++
            if (currentTripleIndex >= WeeklyBasicSingleton.hashMapWeeklyBasics.size) {
        ...
        binding.imageFlashCardSaveWhite.setOnClickListener {
            with(binding){
                ...
                if (currentTripleIndex >= 0 && currentTripleIndex < WeeklyBasicSingleton.hashMapWeeklyBasics.size) {
                    // Remove the item at the current index from your data structure (e.g., HashMap)
                    val removedTriple = WeeklyBasicSingleton.hashMapWeeklyBasics.entries.elementAt(currentTripleIndex)
                    WeeklyBasicSingleton.hashMapWeeklyBasics.remove(removedTriple.key)
        ...
        binding.cardLearning.setOnClickListener {
            findNavController().navigate(R.id.action_weeklyBasicFlashcardFragment_to_toLearnFlashCards)
        }
