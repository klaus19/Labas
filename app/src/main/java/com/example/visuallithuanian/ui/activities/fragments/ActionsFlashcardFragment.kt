...
class ActionsFlashcardFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val savedProgress = flashPreferencesHelper.getProgressActions()
        ...
        binding.imageFlashCardSaveWhite.setOnClickListener {
            with(binding) {
                ...
                if (currentTripleIndex >= 0 && currentTripleIndex < ActionsSingleton.hashMapActions.size) {
        ...
        with(binding) {
            btnFlip.setOnClickListener {
                ...
                flashPreferencesHelper.saveProgressActions(progress)
