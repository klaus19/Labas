...
class ProfessionFlashcardFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.floatingActionButton.setOnClickListener {
            findNavController().navigate(R.id.action_professionFlashcardFragment_to_sentenceFragment)
        }
        ...
        binding.imageFlashCard.setOnClickListener {
            ...
            currentTripleIndex++
            if (currentTripleIndex >=ProfessionSingleton.hashMapProfession.size) {
        ...
        binding.imageFlashCardSaveWhite.setOnClickListener {
            with(binding) {
                ...
                if (currentTripleIndex >= 0 && currentTripleIndex <ProfessionSingleton.hashMapProfession.size) {
                    // Remove the item at the current index from your data structure (e.g., HashMap)
                    val removedTriple =ProfessionSingleton.hashMapProfession.entries.elementAt(currentTripleIndex)
                   ProfessionSingleton.hashMapProfession.remove(removedTriple.key)
        ...
        binding.cardLearning.setOnClickListener {
            findNavController().navigate(R.id.action_professionFlashcardFragment_to_toLearnFlashCards)
        }
