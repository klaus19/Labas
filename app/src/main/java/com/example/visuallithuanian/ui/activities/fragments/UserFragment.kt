...
class UserFragment : Fragment() {
    ...
    private fun populateLanguageList() {
        languageModelArrayList.apply {
            add(LanguageModel("Vaisiai", R.drawable.fruits, "Fruits"))
            add(LanguageModel("Gėlės", R.drawable.flowers, "Flowers"))
            add(LanguageModel("Daržovės", R.drawable.vegetable, "Vegetables"))
            add(LanguageModel("Institucijos", R.drawable.campus, "Institutions"))
            add(LanguageModel("Saulės sistema", R.drawable.universe, "Solar System"))
            add(LanguageModel("Metų laikai", R.drawable.season, "Seasons"))
            add(LanguageModel("Kryptys", R.drawable.compass, "Directions"))
            add(LanguageModel("Gyvūnai", R.drawable.animals, "Animals"))
            add(LanguageModel("Paukščiai", R.drawable.birds, "Birds"))
            add(LanguageModel("Sporto", R.drawable.sports, "Sports"))
            add(LanguageModel("Spalvos", R.drawable.colors, "Colors"))
            add(LanguageModel("Kontinentai", R.drawable.continents, "Continents"))
            add(LanguageModel("Numeriai", R.drawable.numbers, "Numbers"))
            add(LanguageModel("Mėnesiai", R.drawable.months, "Months"))
            add(LanguageModel("Dienos", R.drawable.days, "Days"))
            add(LanguageModel("Laikas", R.drawable.time, "Time"))
            add(LanguageModel("Profesija", R.drawable.profession, "Profession"))
            add(LanguageModel("Transportas", R.drawable.transportation, "Transportations"))
        }
    }
}
