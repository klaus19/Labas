...
class NatureFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        hashMap["tree"] = Triple("medis", R.drawable.tree, R.raw.tree)
        hashMap["forest"] = Triple("miškas", R.drawable.forest, R.raw.forest)
        hashMap["grass"] = Triple("žolė", R.drawable.grass, R.raw.grass)
        hashMap["flower"] = Triple("gėlė", R.drawable.flowers, R.raw.flower)
        hashMap["sky"] = Triple("dangus", R.drawable.sky, R.raw.sky)
        hashMap["sun"] = Triple("saulė", R.drawable.sun, R.raw.sun)
        hashMap["moon"] = Triple("mėnulis", R.drawable.moon, R.raw.moon)
        hashMap["star"] = Triple("žvaigždė", R.drawable.star, R.raw.star)
        ...
        hashMap["thunderstorm"] = Triple("perkūnija", R.drawable.thunderstorm, R.raw.thunderstorm)
        hashMap["mountain"] = Triple("kalnas", R.drawable.mountain, R.raw.mountain)
        hashMap["camp"] = Triple("stovykla", R.drawable.camp, R.raw.camp)
        hashMap["light and darkness"] = Triple("šviesa ir tamsa", R.drawable.halfaday, R.raw.lightanddarkness)
        hashMap["clean water"] = Triple("švarus vanduo", R.drawable.cleanwater, R.raw.cleanwater)
        hashMap["It rains"] = Triple("Lyja lietus", R.drawable.itrains, R.raw.itrains)
        hashMap["the snow"] = Triple("sniegas", R.drawable.snow, R.raw.snow)
        hashMap["a storm"] = Triple("audra", R.drawable.storm, R.raw.storm)
        hashMap["a blizzard"] = Triple("pūga", R.drawable.blizzard, R.raw.blizzard)
        hashMap["her bouquet is beautiful"] = Triple("jos puokštė yra graži",
            R.drawable.bouquet,
            R.raw.herboquetbeautiful
        )
