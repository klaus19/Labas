...
class WorkPlaceLanguage : Fragment() {
    ...
    override fun onCreateView(
        ...
        hashMap["employee"] = Triple("darbuotojas / darbotoja", R.drawable.employee1, R.raw.employee)
        ...
        hashMap["to begin"] = Triple("prasidėti", R.drawable.begin,R.raw.tobegin)
        ...
        hashMap["to print"] = Triple("išspausdinti",R.drawable.print,R.raw.toprint)
        ...
        hashMap["to inform"] = Triple("perduoti", R.drawable.inform, R.raw.toinform)
        hashMap["to take"] = Triple("nunešti",R.drawable.take,R.raw.totake)
