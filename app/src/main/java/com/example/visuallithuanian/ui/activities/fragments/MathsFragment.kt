...
class MathsFragment : Fragment() {
    ...
    lateinit var binding: FragmentMathsBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentMathsBinding.inflate(inflater,container,false)
        ...
        val savedProgress = flashPreferencesHelper.getProgressMath()
        ...
        binding.imageFlashCardSaveWhite.setOnClickListener {
            with(binding) {
                ...
                if (currentTripleIndex >= 0 && currentTripleIndex < MathsSingleton.hashMapMaths.size) {
                    // Remove the item at the current index from your data structure (e.g., HashMap)
                    val removedTriple = MathsSingleton.hashMapMaths.entries.elementAt(currentTripleIndex)
                    MathsSingleton.hashMapMaths.remove(removedTriple.key)
        ...
        with(binding) {
            btnFlip.setOnClickListener {
                ...
                flashPreferencesHelper.saveProgressMaths(progress)
