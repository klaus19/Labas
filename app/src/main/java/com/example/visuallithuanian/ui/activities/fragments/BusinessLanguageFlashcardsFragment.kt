...
import com.example.visuallithuanian.constants.BusinessLanguageSingleton
...
import com.example.visuallithuanian.databinding.FragmentBusinessLanguageFlashcardsBinding
...
class BusinessLanguageFlashcardsFragment : Fragment() {

    lateinit var binding: FragmentBusinessLanguageFlashcardsBinding
    ...
    var isFront = true
    private val totalTriples = 60 // change the value to the actual number of entries in your hashMap
    ...
    override fun onCreateView(
        ...
        binding = FragmentBusinessLanguageFlashcardsBinding.inflate(inflater, container, false)
        ...
        val savedProgress = flashPreferencesHelper.getProgressBusiness()
        ...
        binding.floatingActionButton.setOnClickListener {
            findNavController().navigate(R.id.action_businessLanguageFlashcardsFragment_to_sentenceFragment)
        }
        ...
        currentTriple =BusinessLanguageSingleton.hashMapBusiness.entries.elementAt(currentTripleIndex)
        ...
        binding.imageFlashCard.setOnClickListener {
            ...
            currentTripleIndex++
            if (currentTripleIndex >=BusinessLanguageSingleton.hashMapBusiness.size) {
        ...
        binding.imageFlashCardSaveWhite.setOnClickListener {
            with(binding) {
                ...
                if (currentTripleIndex >= 0 && currentTripleIndex <BusinessLanguageSingleton.hashMapBusiness.size) {
                    // Remove the item at the current index from your data structure (e.g., HashMap)
                    val removedTriple =BusinessLanguageSingleton.hashMapBusiness.entries.elementAt(currentTripleIndex)
                   BusinessLanguageSingleton.hashMapBusiness.remove(removedTriple.key)
        ...
        binding.gifImageView.setOnClickListener {
            findNavController().navigate(R.id.action_businessLanguageFlashcardsFragment_to_toLearnFlashCards)
        }
        ...
        with(binding) {
            btnFlip.setOnClickListener {
                ...
                flashPreferencesHelper.savedProgressBusiness(progress)
