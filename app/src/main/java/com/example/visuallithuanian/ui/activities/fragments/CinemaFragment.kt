...
class CinemaFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.floatingActionButton.setOnClickListener {
            findNavController().navigate(R.id.action_cinemaFragment_to_sentenceFragment)
        }
        ...
        binding.imageFlashCard.setOnClickListener {
            ...
            currentTripleIndex++
            if (currentTripleIndex >= CinemaSingleton.hashMapCinemawords.size) {
        ...
        binding.imageFlashCardSaveWhite.setOnClickListener {
            with(binding) {
                ...
                if (currentTripleIndex >= 0 && currentTripleIndex < CinemaSingleton.hashMapCinemawords.size) {
