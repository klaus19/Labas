...
class ComputerTechnologyFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        hashMap["screen"] = Triple("ekranas", R.drawable.screen,R.raw.sleep)
        hashMap["awake"] = Triple("budrus", R.drawable.awake,R.raw.sleep)
        hashMap["Programmer"] = Triple("Programuotojas", R.drawable.programmer,R.raw.sleep)
        hashMap["Interface"] = Triple("Sąsaja", R.drawable.interface1,R.raw.sleep)
        hashMap["slot"] = Triple("lizdas", R.drawable.slot,R.raw.sleep)
        hashMap["sent an email"] = Triple("Išsiuntė elektroninį laišką.", R.drawable.sentemail,R.raw.sleep)
        hashMap["account"] = Triple("sąskaitą", R.drawable.account1,R.raw.sleep)
        hashMap["network"] = Triple("tinklo", R.drawable.network,R.raw.sleep)
        hashMap["retrieve"] = Triple("atkurti", R.drawable.retrieve,R.raw.sleep)
        hashMap["a backup copy"] = Triple("atsarginę kopiją", R.drawable.backupcopy,R.raw.sleep)
        hashMap["record"] = Triple("įrašas", R.drawable.record,R.raw.sleep)
        hashMap["Log out"] = Triple("Atsijungti", R.drawable.logout,R.raw.sleep)
        hashMap["to save"] = Triple("sutaupyti", R.drawable.tosave,R.raw.sleep)
        hashMap["set-up"] = Triple("sąranka", R.drawable.setup,R.raw.sleep)
        hashMap["computer mouse"] = Triple("Kompiuterio pelė", R.drawable.computermouse,R.raw.sleep)
