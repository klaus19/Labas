...
class CafeFlashcardsFragment : Fragment() {

    lateinit var binding: FragmentCafeFlashcardsBinding
    ...
    var isFront = true
    private val totalTriples = 29 // change the value to the actual number of entries in your hashMap
    ...
    override fun onCreateView(
        ...
        binding = FragmentCafeFlashcardsBinding.inflate(inflater, container, false)
        ...
        val savedProgress = flashPreferencesHelper.getProgressCafe()
        ...
        binding.floatingActionButton.setOnClickListener {
            findNavController().navigate(R.id.action_cafeFlashcardsFragment_to_sentenceFragment)
        }
        ...
        binding.imageFlashCard.setOnClickListener {
            ...
            currentTripleIndex++
            if (currentTripleIndex >= CafeSingleton.hashMapCafeWords.size) {
        ...
        binding.imageFlashCardSaveWhite.setOnClickListener {
            with(binding) {
                ...
                if (currentTripleIndex >= 0 && currentTripleIndex < CafeSingleton.hashMapCafeWords.size) {
                    // Remove the item at the current index from your data structure (e.g., HashMap)
                    val removedTriple = CafeSingleton.hashMapCafeWords.entries.elementAt(currentTripleIndex)
                    CafeSingleton.hashMapCafeWords.remove(removedTriple.key)
        ...
        binding.cardLearning.setOnClickListener {
            findNavController().navigate(R.id.action_cafeFlashcardsFragment_to_toLearnFlashCards)
        }
        ...
        with(binding) {
            btnFlip.setOnClickListener {
                ...
                currentTripleIndex = (currentTripleIndex + 1) % CafeSingleton.hashMapCafeWords.size
                ...
                flashPreferencesHelper.savedProgressCafe(progress)
