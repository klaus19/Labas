...
object VillageSingleton {

    val hashMapVillageWords = HashMap<String, Triple<String, Int, Int>>()

    init {
        hashMapVillageWords["Grocery Store"] = Triple("maisto prekių parduotuvė", R.drawable.grocerystore, R.raw.computer)
        hashMapVillageWords["Club"] = Triple("klubas", R.drawable.club, R.raw.computer)
        hashMapVillageWords["University"] = Triple("Universitetas", R.drawable.university11, R.raw.computer)
        hashMapVillageWords["shopping center"] = Triple("prekybos centras", R.drawable.shoppingcenter, R.raw.computer)
        hashMapVillageWords["modern"] = Triple("modernus", R.drawable.modern, R.raw.computer)
        hashMapVillageWords["residents"] = Triple("gyventojai", R.drawable.residents, R.raw.computer)
        hashMapVillageWords["smog"] = Triple("smogas", R.drawable.smog, R.raw.computer)
        ...
        hashMapVillageWords["Shop"] = Triple("Parduotuvė", R.drawable.shop, R.raw.computer)
        hashMapVillageWords["Distance"] = Triple("Atstumas", R.drawable.distance, R.raw.computer)
        hashMapVillageWords["City Hall"] = Triple("rotušė", R.drawable.xityhall, R.raw.computer)
        hashMapVillageWords["Bus Stop"] = Triple("Autobusų stotelė", R.drawable.busstop, R.raw.computer)
        ...
        hashMapVillageWords["kindergarten"] = Triple("darželis", R.drawable.kindergarten, R.raw.computer)
        hashMapVillageWords["train station"] = Triple("traukinių stotis", R.drawable.trainstation, R.raw.computer)
        ...
        hashMapVillageWords["museum"] = Triple("muziejus", R.drawable.museum, R.raw.computer)
        hashMapVillageWords["In the theater"] = Triple("Teatras", R.drawable.theater, R.raw.computer)
        hashMapVillageWords["dangerous"] = Triple("pavojinga", R.drawable.dangerous, R.raw.computer)
        hashMapVillageWords["statue"] = Triple("statula", R.drawable.statue, R.raw.computer)
