...
class WorkPlaceLanguage : Fragment() {
    ...
    override fun onCreateView(
        ...
        hashMap["holidays, vacation"] = Triple("atostogos", R.drawable.dad1,R.raw.sleep)
        hashMap["to print, prints, printed what?"] = Triple("išspausdinti, išspausdina, išspausdino ką?", R.drawable.mother,R.raw.sleep)
        hashMap["Document"] = Triple("dokumentas", R.drawable.mother,R.raw.sleep)
        hashMap["copy"] = Triple("kopija", R.drawable.mother,R.raw.sleep)
        hashMap["to inform, informs, informed what? who?"] = Triple("perduoti, perduoda, perdavė ką? kam?", R.drawable.mother,R.raw.sleep)
        hashMap["to give/hand, gives/hands, gave what? to whom?"] = Triple("paduoti, paduoda, padavė ką? kam?", R.drawable.mother,R.raw.sleep)
        hashMap["to say, says, said what? to whom?"] = Triple("pasakyti, pasako, pasakė ką? kam?", R.drawable.mother,R.raw.sleep)
        hashMap["to take, takes, took what? to whom?"] = Triple("nunešti, nuneša, nunešė ką? kam?", R.drawable.mother,R.raw.sleep)
        hashMap["to write, writes, wrote what? to whom?"] = Triple("rašyti, rašo, raše ką? kam?", R.drawable.mother,R.raw.sleep)
        hashMap["to send, sends, sent what?"] = Triple("išsiųsti, išsiunčia, išsiunte ką?", R.drawable.mother,R.raw.sleep)
