...
class FeelingsFragment : Fragment() {
    lateinit var binding: FragmentFeelingsBinding
    ...
    override fun onCreateView(
        ...
        val savedProgress = flashPreferencesHelper.getProgressFeelings()
        ...
        binding.imageFlashCardSaveWhite.setOnClickListener {
            with(binding) {
                ...
                if (currentTripleIndex >= 0 && currentTripleIndex <  FeelingsSingleton.hashMapFeelings.size) {
        ...
        with(binding) {
            btnFlip.setOnClickListener {
                ...
                flashPreferencesHelper.saveProgressFeelings(progress)
