...
class KeyPhrasesFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        hashMap["Where is the bus stop?"] = Triple("Kur yra autobusų stotelė?", R.drawable.busstop,R.raw.kuryraautobusustotele)
        hashMap["How much it costs?"] = Triple("Kiek tai kainuoja?", R.drawable.howmuchcost,R.raw.kiektaikainuoja)
        hashMap["Go left"] = Triple("Eik į kairę", R.drawable.left1,R.raw.eikikaire)
        hashMap["I do not understand"] = Triple("Nesuprantu.", R.drawable.dontunderstand,R.raw.nesuprantu)
        hashMap["See you soon"] = Triple("Greitai pasimatysime", R.drawable.seeyou,R.raw.greitaipasimatysime)
        ...
        hashMap["separate beds"] = Triple("atskiros lovos", R.drawable.separatebeds,R.raw.atskiroslovos)
        hashMap["Call an ambulance."] = Triple("Iškvieskite greitąją pagalbą.", R.drawable.ambulance,R.raw.iskvieskitegreitajapagalba)

        hashMap["Can you repeat that?"] = Triple("Ar galite tai pakartoti?", R.drawable.repeat,R.raw.argalitetaipakartoti)
        hashMap["Can I pay?"] = Triple("Ar galiu sumokėti?", R.drawable.canpay,R.raw.argaliusumoketi)
        hashMap["What is your name?"] = Triple("Koks tavo vardas?", R.drawable.name,R.raw.kokstavovardas)
        ...
        hashMap["Can you write it down?"] = Triple("Ar galite tai užrašyti?", R.drawable.write,R.raw.argalitetaiuzrasyti)
        hashMap["What do you recommend?"] = Triple("Ką rekomenduojate?", R.drawable.recommend,R.raw.karekomenduojate)
        ...
        hashMap["Is there a good restaurant nearby?"] = Triple("Ar netoli yra geras restoranas?", R.drawable.restaurant,R.raw.download)
        hashMap["Nice to meet you"] = Triple("Malonu tave matyti", R.drawable.meetyou,R.raw.download)
        ...
        hashMap["Do you know where ... is?"] = Triple("Ar žinote, kur yra ...?", R.drawable.doyouknowhere,R.raw.download)
        hashMap["train station"] = Triple("traukinių stotis", R.drawable.trainstation1,R.raw.download)
        hashMap["at the police station"] = Triple("policijos nuovadoje", R.drawable.policestation,R.raw.download)

        hashMap["single room"] = Triple("vienvietis kambarys", R.drawable.singleroom,R.raw.download)
        hashMap["passport"] = Triple("pasas", R.drawable.airport,R.raw.download)
        hashMap["Where is the toilet?"] = Triple("Kur yra tualetas?", R.drawable.toilet,R.raw.download)
        hashMap["Reception"] = Triple("Registratūra", R.drawable.receiption,R.raw.download)
        hashMap["How do I get to ....?"] = Triple("Kaip man nusigauti į ....?", R.drawable.howget,R.raw.download)
        ...
        hashMap["boarding pass"] = Triple("įlaipinimo bilietas", R.drawable.boardingpass,R.raw.download)
        hashMap["Do you speak English?"] = Triple("Ar tu kalbi angliškai?", R.drawable.english,R.raw.download)
        ...
        hashMap["Nice to meet you"] = Triple("Malonu susipažinti", R.drawable.nicetomeetyou,R.raw.download)
        hashMap["I do not speak english."] = Triple("Aš nemoku anglų kalbos.", R.drawable.english,R.raw.download)
        hashMap["When does the bus leave?"] = Triple("Kada išvyksta autobusas?", R.drawable.busstop,R.raw.download)
        ...
        hashMap["Can you call a taxi?"] = Triple("Ar galite išsikviesti taksi?", R.drawable.taxi,R.raw.download)
        hashMap["map"] = Triple("Žemėlapis", R.drawable.map1,R.raw.download)
        hashMap["I am allergic to nuts."] = Triple("Esu alergiška riešutams.", R.drawable.nuts,R.raw.download)
        ...
        hashMap["Can I borrow ...?"] = Triple("Ar galiu pasiskolinti ...?", R.drawable.borrow,R.raw.download)
        hashMap["When does breakfast start?"] = Triple("Kada prasideda pusryčiai?", R.drawable.breakfast,R.raw.download)
        hashMap["I'm sorry"] = Triple("Atsiprašau", R.drawable.sorry,R.raw.download)
        hashMap["Enjoy your stay."] = Triple("Mėgaukitės viešnage.", R.drawable.enjoyurstay,R.raw.download)
        hashMap["How long does it take to get to ....?"] = Triple("Per kiek laiko reikia patekti į ....?", R.drawable.howlong,R.raw.download)
        hashMap["Can I get your ID card?"] = Triple("Ar galiu gauti jūsų asmens tapatybės kortelę?", R.drawable.idcard1,R.raw.download)
