...
object RightsSingleton {
    ...
    init {
        ...
        hashMapRights["security deposit"] = Triple("užstatas", R.drawable.securitydeposit, R.raw.computer)
        ...
        hashMapRights["child abuse"] = Triple("prievartą prieš vaiką", R.drawable.childabuse, R.raw.computer)
        hashMapRights["foster children"] = Triple("globojamų vaikų", R.drawable.fosterchildren, R.raw.computer)
        hashMapRights["danger"] = Triple("pavojus", R.drawable.danger, R.raw.computer)
