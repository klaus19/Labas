...
class BasicActionsFlashcard : Fragment() {
    ...
    override fun onCreateView(
        ...
        hashMap["to repair"] = Triple("sutaisyti", R.drawable.repair,R.raw.relocation)
        hashMap["to take"] = Triple("paimti, imk", R.drawable.take,R.raw.relocation)
        hashMap["I walk and run"] = Triple("aš einu ir bėgu", R.drawable.walk,R.raw.relocation)
        hashMap["I fly or swim"] = Triple("Aš skrendu arbo plaukiu", R.drawable.fly,R.raw.relocation)
        hashMap["to open"] = Triple("atidaryti", R.drawable.open1,R.raw.relocation)
        hashMap["to close"] = Triple("uždaryti", R.drawable.close,R.raw.relocation)
        hashMap["depart and arrive"] = Triple("išvykti ir atvykti", R.drawable.depart,R.raw.relocation)
        hashMap["on and off"] = Triple("ijungti ir išjungti", R.drawable.onoff,R.raw.relocation)
        hashMap["to give"] = Triple("duoti", R.drawable.togive,R.raw.relocation)
        hashMap["I am willing and able"] = Triple("aš noriu ir galiu", R.drawable.ableto,R.raw.relocation)

        hashMap["to put"] = Triple("padėti", R.drawable.toput,R.raw.relocation)
        hashMap["to find"] = Triple("rasti", R.drawable.tofind,R.raw.relocation)
        hashMap["to cook"] = Triple("virti", R.drawable.tocook,R.raw.relocation)
        hashMap["to be produced by"] = Triple("gaminti", R.drawable.toproduce,R.raw.relocation)
