...
//        }
        ...
        hashMap["tree"] = Triple("medis", R.drawable.egg,R.raw.sleep)
        hashMap["forest"] = Triple("miškas", R.drawable.egg,R.raw.sleep)
        hashMap["grass"] = Triple("žolė", R.drawable.egg,R.raw.sleep)
        hashMap["flower"] = Triple("gėlė", R.drawable.flowers,R.raw.sleep)
        hashMap["sky"] = Triple("dangus", R.drawable.egg,R.raw.sleep)
        ...
        hashMap["river"] = Triple("upė", R.drawable.egg,R.raw.sleep)
        hashMap["sea"] = Triple("jūra", R.drawable.egg,R.raw.sleep)

        hashMap["ground"] = Triple("žemės", R.drawable.egg,R.raw.sleep)
        hashMap["field"] = Triple("srityje", R.drawable.egg,R.raw.sleep)
        hashMap["bird"] = Triple("paukštis", R.drawable.egg,R.raw.sleep)
        hashMap["lake"] = Triple("ežeras", R.drawable.egg,R.raw.sleep)
        hashMap["rain"] = Triple("lietus", R.drawable.egg,R.raw.sleep)
        hashMap["thunderstorm"] = Triple("perkūnija", R.drawable.egg,R.raw.sleep)
        hashMap["mountain"] = Triple("kalnis", R.drawable.egg,R.raw.sleep)
        hashMap["camp"] = Triple("stovykla", R.drawable.egg,R.raw.sleep)
        hashMap["light and darkness"] = Triple("šviesa ir tamsa", R.drawable.halfaday,R.raw.sleep)
        hashMap["clean water"] = Triple("švarus vanduo", R.drawable.egg,R.raw.sleep)

        hashMap["It rains"] = Triple("Lyja lietus", R.drawable.egg,R.raw.sleep)
        hashMap["the snow"] = Triple("sniegas", R.drawable.egg,R.raw.sleep)
        hashMap["a storm"] = Triple("audra", R.drawable.egg,R.raw.sleep)
        hashMap["a blizzard"] = Triple("pūga", R.drawable.egg,R.raw.sleep)
        hashMap["her bouquet is beautiful"] = Triple("jos puokštė yra graži", R.drawable.egg,R.raw.sleep)
