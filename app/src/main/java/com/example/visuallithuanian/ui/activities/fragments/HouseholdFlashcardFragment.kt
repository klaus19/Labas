...
class HouseholdFlashcardFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val savedProgress = flashPreferencesHelper.getProgressHouseHold()
        ...
        binding.floatingActionButton.setOnClickListener {
            findNavController().navigate(R.id.action_householdFlashcardFragment_to_sentenceFragment)
        }
        ...
        with(binding) {
            btnFlip.setOnClickListener {
                ...
                flashPreferencesHelper.savedProgressHouseHold(progress)
