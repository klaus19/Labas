...
//        }
        ...
        binding.imageFlashCardSaveWhite.setOnClickListener {
            with(binding){
                ...
                if (currentTripleIndex >= 0 && currentTripleIndex < VillageSingleton.hashMapVillageWords.size) {
                    // Remove the item at the current index from your data structure (e.g., HashMap)
                    val removedTriple = VillageSingleton.hashMapVillageWords.entries.elementAt(currentTripleIndex)
                    VillageSingleton.hashMapVillageWords.remove(removedTriple.key)
