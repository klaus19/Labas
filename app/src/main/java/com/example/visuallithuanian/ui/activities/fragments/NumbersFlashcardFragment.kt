...
class NumbersFlashcardFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        hashMap["first aid"] = Triple("pirmoji pagalba", R.drawable.firstaid, R.raw.firstaid)
        hashMap["zero"] = Triple("nulis", R.drawable.zero, R.raw.zero)
        hashMap["one"] = Triple("vienas", R.drawable.one, R.raw.one)
        hashMap["two"] = Triple("du", R.drawable.two, R.raw.two)
        hashMap["three"] = Triple("trys", R.drawable.three, R.raw.three)
        hashMap["four"] = Triple("keturi", R.drawable.four, R.raw.four)
        hashMap["five"] = Triple("penki", R.drawable.five, R.raw.five)
        hashMap["six"] = Triple("šeši", R.drawable.six, R.raw.six)
        hashMap["seven"] = Triple("septyni", R.drawable.seven, R.raw.seven)
        hashMap["eight"] = Triple("aštuoni", R.drawable.eight, R.raw.eight)
        hashMap["nine"] = Triple("devyni", R.drawable.nine, R.raw.nine)
        hashMap["ten"] = Triple("dešimt", R.drawable.ten, R.raw.ten)
        hashMap["a thousand"] = Triple("tūkstantis", R.drawable.thousand, R.raw.thousand)
        hashMap["ten"] = Triple("dešimt", R.drawable.ten, R.raw.ten)
        hashMap["ten thousand"] = Triple("dešimt tūkstančių", R.drawable.tenthousand, R.raw.tenthousand)
        hashMap["one hundred"] = Triple("šimtas", R.drawable.onehundred, R.raw.onehundred)
        hashMap["one hundred thousand"] = Triple("šimtas tūkstančių", R.drawable.onehundredthousand, R.raw.onehundredthousand)
        hashMap["million"] = Triple("milijonas", R.drawable.million, R.raw.million)
        hashMap["the first train"] = Triple("pirmasis traukinys", R.drawable.firsttrain1, R.raw.firsttrain)
        hashMap["two tickets"] = Triple("du bilietai", R.drawable.twoticket, R.raw.twotickets)
        hashMap["the last train"] = Triple("paskutinis traukinys",R.drawable.lasttrain,R.raw.thelasttrain)
