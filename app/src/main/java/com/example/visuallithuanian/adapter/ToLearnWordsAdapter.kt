...
class ToLearnWordsAdapter:
  ListAdapter<FlashcardPair,ToLearnWordsAdapter.ViewHolder>(WordsComparator()){

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_to_learn_word, parent, false)
