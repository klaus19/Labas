...
import com.example.visuallithuanian.constants.AnimalWordsSingleton
import com.example.visuallithuanian.database.FlashcardPair
import com.example.visuallithuanian.databinding.FragmentAnimalWordsBinding
...
class AnimalWordsFragment : Fragment() {

    lateinit var binding: FragmentAnimalWordsBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentAnimalWordsBinding.inflate(inflater,container,false)
        ...
        val savedProgress = flashPreferencesHelper.getProgressAnimalWords()
        ...
        binding.floatingActionButton.setOnClickListener {
            findNavController().navigate(R.id.action_animalWordsFragment_to_sentenceFragment)
        }
        ...
        currentTriple = AnimalWordsSingleton.hashMapAnimalWords.entries.elementAt(currentTripleIndex)
        ...
        binding.imageFlashCard.setOnClickListener {
            ...
            currentTripleIndex++
            if (currentTripleIndex >= AnimalWordsSingleton.hashMapAnimalWords.size) {
        ...
        binding.imageFlashCardSaveWhite.setOnClickListener {
            with(binding) {
                ...
                if (currentTripleIndex >= 0 && currentTripleIndex < AnimalWordsSingleton.hashMapAnimalWords.size) {
                    // Remove the item at the current index from your data structure (e.g., HashMap)
                    val removedTriple = AnimalWordsSingleton.hashMapAnimalWords.entries.elementAt(currentTripleIndex)
                    AnimalWordsSingleton.hashMapAnimalWords.remove(removedTriple.key)
        ...
        binding.gifImageView.setOnClickListener {
            findNavController().navigate(R.id.action_animalWordsFragment_to_toLearnFlashCards)
        }
        ...
        with(binding) {
            btnFlip.setOnClickListener {
                ...
                flashPreferencesHelper.saveProgressAnimalWords(progress)
