...
class HolidayCelebrations : Fragment() {
    ...
    private fun initializeHashMap() {
        ...
        hashMap["party"] = Triple("vakarėlis", R.drawable.party, R.raw.party)
        hashMap["guest"] = Triple("svečias", R.drawable.guests, R.raw.guest)
        hashMap["to go visit (as a guest)"] = Triple("eiti į svečius", R.drawable.tovisit, R.raw.togovisit)
        hashMap["to invite guests"] = Triple("kviesti į svečius", R.drawable.toinvite, R.raw.toinviteguest)
        hashMap["to be a guest"] = Triple("būti svečiuose", R.drawable.tobeguest, R.raw.tobeaguest)
        hashMap["to give"] = Triple("dovanoti", R.drawable.togive, R.raw.togive)
        hashMap["to get"] = Triple("gauti", R.drawable.toget1, R.raw.toget)
        hashMap["gift"] = Triple("dovana", R.drawable.gift, R.raw.gift)
        hashMap["flower"] = Triple("gėlė", R.drawable.flowers, R.raw.flower)
        hashMap["Postcard"] = Triple("atvirukas", R.drawable.postcard, R.raw.postcard)
        hashMap["to send"] = Triple("išsiųsti", R.drawable.send1, R.raw.tosend)
        hashMap["cake"] = Triple("tortas", R.drawable.cake, R.raw.cake)
        hashMap["candles"] = Triple("žvakutės", R.drawable.candles, R.raw.candles)
        hashMap["Christmas Eve"] = Triple("Kūčios", R.drawable.christmaseve, R.raw.christmaseve)
        hashMap["to congratulate"] = Triple("sveikinti", R.drawable.tocongratulate, R.raw.tocongratulate)
        hashMap["to wish"] = Triple("linkėti,", R.drawable.towish1, R.raw.towish)
        hashMap["Christmas"] = Triple("Kalėdos", R.drawable.christmas, R.raw.christmas)
        hashMap["christmas tree"] = Triple("eglutė", R.drawable.christmastree, R.raw.christamastree)
        hashMap["Santa Claus"] = Triple("Kalėdų senelis", R.drawable.santaclaus, R.raw.santaclaus)
        hashMap["candle"] = Triple("žvakė", R.drawable.candle, R.raw.candle)
        hashMap["New Year"] = Triple("Naujieji Metai", R.drawable.happynewyear, R.raw.newyear)
        hashMap["to wait"] = Triple("laukti", R.drawable.towait1, R.raw.towait)
        hashMap["fireworks"] = Triple("fejerverkai", R.drawable.fireworks, R.raw.fireworks)
        hashMap["Easter"] = Triple("Velykos", R.drawable.easter, R.raw.easter)
        hashMap["Easter egg"] = Triple("margutis", R.drawable.easteregg, R.raw.easteregg)
        hashMap["to dye"] = Triple("dažyti", R.drawable.todye, R.raw.todye)
        hashMap["public holidays"] = Triple("valstybinės šventės", R.drawable.holiday1, R.raw.publicholidays)
        hashMap["flag"] = Triple("vėliava", R.drawable.flag, R.raw.flag)
        hashMap["success"] = Triple("sėkmė", R.drawable.success, R.raw.success)
        hashMap["happiness"] = Triple("laimė", R.drawable.happiness, R.raw.happiness)
        hashMap["joy"] = Triple("džiaugsmas", R.drawable.joy, R.raw.joy)
        hashMap["happy"] = Triple("laimingas", R.drawable.happy, R.raw.happy)
        hashMap["beloved"] = Triple("mylimas", R.drawable.beloved, R.raw.beloved)
        hashMap["honourable"] = Triple("gerbiamas,", R.drawable.honorable, R.raw.honourable)
        hashMap["colourful"] = Triple("spalvingas", R.drawable.colorful, R.raw.colourful)
        hashMap["Popular"] = Triple("populiarus", R.drawable.popular, R.raw.popular)
